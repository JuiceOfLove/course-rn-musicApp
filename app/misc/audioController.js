...
export const play = async (playbackObj, uri, lastPosition) => {
  try {
    ...
    console.log('ошибка внутри вспомогательного метода play', error.message);
  }
};
...
export const pause = async playbackObj => {
  try {
    ...
    console.log('ошибка внутри helper метода pause', error.message);
  }
};
...
export const resume = async playbackObj => {
  try {
    ...
    console.log('ошибка внутри helper метода resume', error.message);
  }
};
...
export const playNext = async (playbackObj, uri) => {
  try {
    ...
    console.log('ошибка внутри helper метода playNext', error.message);
  }
};
